...
import ApexChart from "./global";

export class Bydep_ret extends Component {
    constructor(props){
        super(props)
        this.state = {
  ...
  render() {
    return (
      ...
      <div className="card-body">
                <div className='card-title'> Action en retard par departement  </div>
