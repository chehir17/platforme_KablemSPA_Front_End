            ...
            <div className="col-lg-7 mx-auto text-white">
              <div className="row align-items-center d-flex flex-row">
                ...
                <div className="col-lg-6 error-page-divider text-lg-left pl-lg-4">
                  <h2>Désolé!</h2>
                  <h3 className="font-weight-light">vous n'avez pas le droit pour accéder cette page </h3>
                </div>
              </div>
              <div className="row mt-5">
                <div className="col-12 text-center mt-xl-2">
                  <Link className="text-white font-weight-medium" to="/dashboard">Retourner au tableau du bord</Link>
                </div>
              </div>
            </div>
          </div>
